  ...
  <div class="content">
	...
	<marquee behavior="alternate" scrolldelay="100" scrollamount="3" onmouseover="this.stop();" onmouseout="this.start();">
                        <p class="fl_left">
                            ...
                            <a href="pdf/Research Facility Notice.pdf" target="_blank" rel="noopener"><font style="text-shadow: 0 0 1px;e";>This is important news.</font> <img width="33" height="16" src="images/new_red.gif"></a> 
				   				   </marquee>
					</div>
   <div class="jumbotron">
	...
	<div class="row">
             ...
             <img id="myImg1" src="images/g1.jpg" alt="Snow" style="width:100%;">
		     ...
		     <div class="col-sm-3">
		      <div class="imagecenter">
             <img id="myImg2" src="images/g1.jpg" alt="Snow" style="width:100%;"><div class="overlay">My Name is John</div>
		     </div>
			 </div>
		  
		     <div class="col-sm-3">
		      <div class="imagecenter">
             <img id="myImg3" src="images/g1.jpg" alt="Snow" style="width:100%;"><div class="overlay">My Name is John</div>
		     </div>
			 </div>
		  
		     <div class="col-sm-3">
		      <div class="imagecenter">
             <img id="myImg4" src="images/g1.jpg" alt="Snow" style="width:100%;"><div class="overlay">My Name is John</div>
		     </div>
			 </div>
